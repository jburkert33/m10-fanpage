        ...
        <>
            ...
            <div className="distribution-map">
                ...
                <button className="map-point" style={{ top: '30%', left: '36%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">Hobbiton</strong></h2>
                ...
                <button className="map-point" style={{ top: '20%', left: '70%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">The Lonely Mountain</strong></h2>
                ...
                <button className="map-point" style={{ top: '60%', left: '52%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">Helms Deep</strong></h2>
                ...
                <button className="map-point" style={{ top: '70%', left: '67%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">Minas Tirith</strong></h2>
                ...
                <button className="map-point" style={{ top: '55%', left: '51%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">Isengard</strong></h2>
                ...
                <button className="map-point" style={{ top: '62%', left: '55%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">Edoras</strong></h2>
                ...
                <button className="map-point" style={{ top: '66%', left: '73%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">MT Doom</strong></h2>
                ...
                <button className="map-point" style={{ top: '40%', left: '52%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">Moria</strong></h2>
                ...
                <button className="map-point" style={{ top: '28%', left: '56%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">Rivendell</strong></h2>
                ...
                <button className="map-point" style={{ top: '30%', left: '28%' }}>
                    <div className="content">
                        <div className="centered-y">
                            <h2 id="subTitle"><strong id="subTitle-strong">The Grey Havens</strong></h2>
